...
def test_code(test_case):
    ...
    # Find end effactor rotation matrix
    ...
    A = 1.501
    B = sqrt(pow(sqrt((WC[0] ** 2 + WC[1] ** 2) - 0.35), 2) + pow((WC[2] - 0.75), 2))
    C = 1.25
    ...
    your_wc = [WC[idx] for idx in range(3)]  # <--- Load your calculated WC values in this array
    # <--- Load your calculated end effector value from your forward kinematics
    your_ee = [FK[idx, 3] for idx in range(3)]
    ########################################################################################
...
if __name__ == "__main__":
    ...
    for idx in range(3):
        print "Test Case {} Result".format(idx+1)
